  ...
  <section class="restaurant">
    <div class="floor_text_wrapper">
      <ul>
        <li>
          <div
            :class="{ floor_text: true, active: floor === 1 }"
        ...
        <li>
          <div
            :class="{ floor_text: true, active: floor === 2 }"
    ...
    <div class="scene_wrapper_box">
      <div class="scene_wrapper">
        <div class="scene_wrapper_item" @click="handleChangeSceneOut">
          ...
          >
            <path
              d="M21.5524 10.0096C19.8013 11.4427 17.8131 12.253 15.5879 12.4405C13.3627 12.628 11.2686 12.1551 9.30559 11.0218C7.99211 10.2634 6.8972 9.28489 6.02085 8.0861C5.1445 6.88732 4.53388 5.55328 4.18898 4.08399L2.46398 7.07178L0.731934 6.07178L4.23193 0.00959963L10.2941 3.5096L9.29411 5.24165L6.08982 3.39165C6.35094 4.63937 6.84461 5.77598 7.57082 6.80148C8.29703 7.82698 9.20862 8.65639 10.3056 9.28973C11.7778 10.1397 13.356 10.5313 15.0401 10.4643C16.7242 10.3974 18.2671 9.88334 19.6688 8.9221L21.5524 10.0096Z"
              fill="#5F6368"
            />
          </svg>
        </div>
        <div class="scene_wrapper_item">Свайп</div>
